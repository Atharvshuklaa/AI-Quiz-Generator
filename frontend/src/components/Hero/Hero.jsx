    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-28">
        ...
        <div className="text-center">
          ...
          {/* Badge */}
          <p className="inline-block bg-blue-100 text-blue-700 px-5 py-2 rounded-full font-semibold uppercase tracking-widest text-sm shadow-sm">
            🚀 AI Powered Quiz Generation
          </p>

          {/* Main Heading */}
          <h1 className="mt-8 text-6xl md:text-7xl font-extrabold leading-tight text-slate-900">
